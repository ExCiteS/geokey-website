...
We are happy to announce the first release of 2015 today. Besides lots of bug fixes this release brings a lot of new features.
...
- We have build the basis for you to easily add functionality to GeoKey using custom extensions. We will explain in a different post how to create and register extensions with GeoKey.
...
As mentioned before, updating requires a bit of work this time. But we have compiled all necessary here.
